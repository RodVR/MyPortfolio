  ...
  return (
    <section id="works">
      ...
      <div className="worksImgs">
        ...
        <div className='work'>
          <a href='https://github.com/RodVR/blackjack-game' target='_blank' rel='noreferrer'>
          <img src={Project2} alt="" className="worksImg" />
          </a>
          <h3>Blackjack</h3>
          <p>Fun little Blackjack game I worked on using JavaScript and a deck of cards API to show the cards instead of just numbers.</p>
        </div>
        <div className='work'>
